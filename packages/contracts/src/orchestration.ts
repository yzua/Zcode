...
export const GlmModelSelection = Schema.Struct({
	provider: Schema.Literal("glmClaudeAgent"),
	model: TrimmedNonEmptyString,
	options: Schema.optionalKey(ClaudeModelOptions),
});
...
export const OrchestrationThread = Schema.Struct({
	...
	interactionMode: ProviderInteractionMode.pipe(
		Schema.withDecodingDefault(
			Effect.succeed(DEFAULT_PROVIDER_INTERACTION_MODE),
		),
	),
...
export type OrchestrationShellStreamEvent =
	typeof OrchestrationShellStreamEvent.Type;
...
export type OrchestrationSubscribeThreadInput =
	typeof OrchestrationSubscribeThreadInput.Type;
...
export type OrchestrationThreadDetailSnapshot =
	typeof OrchestrationThreadDetailSnapshot.Type;
...
export type OrchestrationThreadStreamItem =
	typeof OrchestrationThreadStreamItem.Type;
