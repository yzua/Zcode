...
export const GlmIcon: Icon = (props) => (
	<svg {...props} viewBox="0 0 256 256" fill="currentColor">
		<path d="M128 16C66.144 16 16 66.144 16 128s50.144 112 112 112 112-50.144 112-112S189.856 16 128 16zm0 20.8c50.432 0 91.2 40.768 91.2 91.2s-40.768 91.2-91.2 91.2-91.2-40.768-91.2-91.2S77.568 36.8 128 36.8zM100.8 89.6v76.8h19.2v-76.8H100.8zm35.2 0v76.8h19.2v-76.8H136z" />
	</svg>
);
